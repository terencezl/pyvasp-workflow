...
structures = ['rocksalt', 'cc', 'wurtzite', 'NiAs', 'WC']
...
def getdf(structures, filepath, elements=None):
    if not elements:
        elements = ['Sc_sv', 'Ti_sv', 'V_sv', 'Cr_pv', 'Mn_pv', 'Fe', 'Co', 'Ni', 'Cu', 'Zn',
            'Y_sv', 'Zr_sv', 'Nb_sv', 'Mo_pv', 'Tc_pv', 'Ru_pv', 'Rh_pv', 'Pd', 'Ag', 'Cd',
                    'Hf_pv', 'Ta_pv', 'W_pv', 'Re', 'Os', 'Ir', 'Pt', 'Au']
        ...
        ind = pd.MultiIndex.from_product([structures, elements], names=['structure', 'element'])
